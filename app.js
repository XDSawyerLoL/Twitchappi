/**
 * STREAMER & NICHE AI HUB - BACKEND (V60 - CHAT ENABLED)
 * =======================================================
 * Basé sur ton code original V50
 * + AJOUT : Support Socket.io pour le Chat Hub
 */
...
// [AJOUT VITAL] Modules pour le Chat
...
// =========================================================
// [AJOUT] CONFIGURATION SERVEUR CHAT
// =========================================================
// On enveloppe l'app Express dans un serveur HTTP standard
const server = http.createServer(app);
const io = new Server(server, { cors: { origin: "*" } });

// Mémoire tampon du chat
const chatHistory = [];
...
server.listen(PORT, () => console.log(`🚀 SERVER V60 (CHAT ENABLED) ON PORT ${PORT}`));

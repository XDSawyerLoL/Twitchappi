 ...
 * ========================================================
 * COPIE INTÉGRALE AVEC CORRECTIFS DE PROD (RENDER + IA FIX)
 */
...
// =========================================================
// 0. INITIALISATION FIREBASE (BLINDÉE POUR RENDER)
// =========================================================
let serviceAccount;
...
// =========================================================
// 1. VARIABLES D'ENVIRONNEMENT & IA
// =========================================================
...
// CORRECTIF ERREUR 404 : On utilise le tag 'latest' qui est plus stable
...
// =========================================================
// 2. SYSTÈME DE CACHE & VARIABLES GLOBALES
// =========================================================
const CACHE = {
    twitchTokens: {}, 
    twitchUser: null, 
...
// --- FONCTION IA CORRIGÉE (Gère l'erreur 404) ---
async function runGeminiAnalysis(prompt) {
    try {
        ...
        // Fallback si le modèle Flash plante encore
...
// =========================================================
// 5. ROUTES API DONNÉES (VOD, FOLLOWS)
// =========================================================
...
// =========================================================
// 6. SCAN 360° + TRACKER (LE CŒUR DU SYSTÈME)
// =========================================================
...
app.post('/critique_ia', async (req, res) => {
    ...
    let prompt = "";
    if (type === 'niche') prompt = `Expert Twitch. Score: ${niche_score}. Historique: ${growth_info}. Analyse "${query}". Donne 3 conseils HTML.`;
...
app.listen(PORT, () => {
    console.log(`===========================================`);
    console.log(` STREAMER HUB V22 (FULL POWER) PORT ${PORT}`);
    console.log(`===========================================`);
});

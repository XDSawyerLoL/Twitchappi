...
// Billing API aliases (compat)
app.get('/api/billing/status', (req,res)=>{
  return res.redirect(307, '/api/credits/status');
});
app.get('/api/billing/packs', (req,res)=>{
  return res.redirect(307, '/api/credits/packs');
});
app.post('/api/billing/buy-pack', (req,res)=>{
  return res.redirect(307, '/api/credits/buy-pack');
});

 ...
 *  - FIREBASE_SERVICE_KEY (legacy, kept for compatibility)
...
function loadFirebaseServiceAccount() {
  ...
  if (envRaw) {
    try {
      ...
      // Convert escaped newlines into real newlines (critical for private_key)
      rawJson = rawJson
        .replace(/\r\n/g, '
')
        .replace(/\n/g, '
...
');
      ...
      // If private_key still contains literal 
 sequences, convert them too
...
app.get('/firebase_status', async (req, res) => {
  try {

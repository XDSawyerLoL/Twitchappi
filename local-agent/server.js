...
function pageHtml(key){
  ...
  return String.raw`<!doctype html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Oryon Local</title><style>
...
setInterval(refreshDiag,2000);setInterval(refreshTunnel,5000);setInterval(loadAccount,2500);loadAccount();refreshDiag();refreshTunnel();</script></body></html>`;
}

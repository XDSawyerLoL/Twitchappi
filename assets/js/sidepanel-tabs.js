(function(){
  ...
  if(h && h > 50){
    // Prefer CSS variable to avoid layout regressions/cropping
    side.style.setProperty('--playerH', Math.round(h) + 'px');
    // Do not force inline height (CSS already uses --playerH)
  }
}

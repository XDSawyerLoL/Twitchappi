const API_BASE = window.location.origin;
    ...
    // Expose key runtime state for other modules (ESM scopes are isolated)
...
// --- Expose UI handlers to global scope (required for inline onclick="" in HTML when using ES Modules) ---

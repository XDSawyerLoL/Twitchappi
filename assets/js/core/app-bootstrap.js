...
function tfToggleBigPicture(force){
  // ORYON TV: Big Picture is mandatory (no toggle)
  tfBigPicture = true;
...
// ORYON TV: Global click capture to guarantee mouse interactions on cards
(function oryonGlobalClickCapture(){
  try{
    if(window.__oryonClickCaptureInstalled) return;
    window.__oryonClickCaptureInstalled = true;
    document.addEventListener('click', (e)=>{
      ...
      // If a card has an inline onclick, let it run; otherwise try to click it
      try{

...
Ce package contient **une seule page HTML** (`NicheOptimizer.html`) avec une architecture **ES Modules** (import/export) orchestrée par `main.js`.
Le HTML reste unique, mais le JS est découpé en modules (core + features).
...
- `public/assets/js/main.js` : **entrypoint ES Modules** (orchestrateur, importe les modules)

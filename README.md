...
## Pricing & Crédits
- Page: `/pricing`
- API: `/api/credits/status`, `/api/credits/packs`, `/api/credits/buy-pack`, `/api/billing/subscribe_pro`
- Modes demo: `CREDITS_DEMO=true` et `BILLING_DEMO=true` (par défaut true)
